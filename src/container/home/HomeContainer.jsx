    ...
    >
      <div className='py-2 flex-1 flex flex-col items-start justify-center gap-6'>
        <div className='flex items-center gap-2 justify-center bg-orange-100 px-4 py-1 rounded-full'>
          <p className='text-base text-orange-500 font-semibold capitalize'>
            miễn phí giao hàng
          </p>
        ...
        <p className='text-base text-textColor text-center md:text-left md:w-[80%]'>
          <span className='text-orange-500'>Tám </span> là nhà hàng đầu tư chỉn
          ...
          {heroData &&
            heroData.map((n, i) => (
              <motion.div
                {...staggerFadeInOut(i)}
                key={i}
                className=' 2xl:w-225 lg:w-190  p-4 bg-cardOverlay backdrop-blur-md rounded-3xl flex flex-col items-center justify-center drop-shadow-lg'
              >
                <img
                  src={n.imageSrc}
